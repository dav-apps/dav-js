...
export { Log, SubscribePushNotifications, UnsubscribePushNotifications, CreateNotification, GetNotification, DeleteNotification } from './lib/providers/DataManager';